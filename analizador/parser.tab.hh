...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_PAUSE ()
      {
        return symbol_type (token::PAUSE);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_IDPART (std::string v)
      {
        return symbol_type (token::IDPART, std::move (v));
      }
#else
      static
      symbol_type
      make_IDPART (const std::string& v)
      {
        return symbol_type (token::IDPART, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RUTA1 (std::string v)
      {
        return symbol_type (token::RUTA1, std::move (v));
      }
#else
      static
      symbol_type
      make_RUTA1 (const std::string& v)
      {
        return symbol_type (token::RUTA1, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RUTA2 (std::string v)
      {
        return symbol_type (token::RUTA2, std::move (v));
      }
#else
      static
      symbol_type
      make_RUTA2 (const std::string& v)
      {
        return symbol_type (token::RUTA2, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
